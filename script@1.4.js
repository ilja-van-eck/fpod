  ...
  function initSlider() {
    ...
    function onMouseDown() {
      mouseDownTimeout = setTimeout(() => {
        gsap.to(".slide-img__w", { clipPath: "inset(4%)", duration: 0.6, ease: "power4.out", overwrite:'auto' });
      }, 100);
    }
    ...
    boxes.forEach((box) => {
      ...
      box.addEventListener("click", () => {
        ...
        tl.set(overlayWrap, { display: "block" })
          ...
          .to([".navbar", ".buy-cta-div.is-desktop"], { y: "-8rem", duration: 0.6 }, 0.2);
    ...
    overlayClose.addEventListener("click", () => {
      ...
      tl.to([overlayScroll, overlayText], { y: "-6rem" }, 0)
        ...
        .to([".navbar", ".buy-cta-div.is-desktop"], { y: "0rem", clearProps: true }, "<+=0.2")
    ...
    if (!isMobile) {
      wrapper.addEventListener("mouseenter", () => {
        ...
        gsap.fromTo(".cursor-el__dot", { autoAlpha: 0 }, { autoAlpha: 1, stagger: 0.03, duration: 0.5, ease: "power1.out", overwrite: "auto" })
        gsap.fromTo(".cursor-el__bg", { clipPath: "inset(50%)" }, { clipPath: "inset(0%)", duration: 0.6, ease: "power3.out", clearProps: true, overwrite: "auto" })
      });
      wrapper.addEventListener("mouseleave", () => {
        gsap.to(".cursor-el__dot", { autoAlpha: 0, stagger: 0.02, duration: 0.5, ease: "power3.out", overwrite: "auto" })
        gsap.to(".cursor-el__bg", { clipPath: "inset(50%)", duration: 0.6, ease: "power3.out", onComplete: () => { gsap.set(cursorInner, { display: "none" }); } })
      });
      ...
      if (config.draggable && typeof Draggable === "function") {
        ...
        draggable = Draggable.create(proxy, {
          ...
          onThrowComplete: () => {
            syncIndex();
            wasPlaying && tl.play();
            gsap.to(".slide-img__w", { clipPath: "inset(0%)", duration: 0.75, ease: "expo.out", overwrite:true });
          },
        })[0];
